 ...
 */
int ResultItemDelegate::getCurrentActionIndex() const
{
 ...
 */
void ResultItemDelegate::setCurrentActionIndex(const int index)
{
...
{
    return {
        itemRect.left() + RESULT_PADDING + (BUTTON_SIZE - ICON_SIZE) / 2,
